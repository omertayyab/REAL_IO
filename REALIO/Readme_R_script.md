...
The first command in the file assigns the directory where data is supposed to be located.
...
Once your data is in place and the `data_dir` variable set to the correct location, you can run the script.
These calculations can take more than 10 minutes altogether, therefore we recommend running the script in chunks of 10-20 lines at a time which gives an opportunity to see if any errors are occuring.